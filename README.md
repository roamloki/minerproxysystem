...
```sh
bash <(curl -s -L https://www.aipool.me/minerproxy/install.sh)
```
...
```sh
bash <(curl -s -L https://www.aipool.me/minerproxy/rms/install.sh)
```
...
```
 wget -N https://www.aipool.me/minerproxy/rms/install.sh;chmod 777 ./install.sh;./install.sh
```
